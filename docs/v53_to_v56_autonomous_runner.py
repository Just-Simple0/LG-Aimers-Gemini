"""
Autonomous Continuous Research Runner - Wave 5 (v53 ~ v56)
===========================================================

차세대 심층 연구 4대 후보:
  1. [Exp 1] v53: 15-Fold CV Ultra-High Density Stacking (Fold당 93.3% 훈련 데이터)
  2. [Exp 2] v54: LightGBM ExtraTrees Mode (극단적 무작위 분할 트리) + CatBoost 10-Fold Stacking
  3. [Exp 3] v55: 10-Fold CV with 3-Seed Multi-Bagging Stacking (10-Fold x 3-Seed 앙상블)
  4. [Exp 4] v56: Asymmetric Regularized Stacking (CatBoost L2 정규화 메타러너)
...
def run_pipeline(train_fe, val_fe, all_features, n_splits=10, extra_trees=False, n_seeds=1):
    t0 = time.time()
...
def main():
    print("=" * 80)
    print("🚀 Autonomous Continuous Runner - Wave 5 (v53 ~ v56)")
    ...
    # =========================================================================
    # [Exp 1] v53: 15-Fold CV Ultra-High Density Stacking (93.3% Train Per Fold)
    # =========================================================================
    print("\n" + "=" * 70)
    print("▶ [Exp 1/2] v53: 15-Fold CV Ultra-High Density Stacking")
    print("=" * 70)
    res_v53 = run_pipeline(fe_v14, val_fe_v14, ALL_FEATURES_V14, n_splits=15)
    res_v53["experiment"] = "Exp 1 (v53-15fold-stacking)"
    batch_results.append(res_v53)
    print(f"  Holdout={res_v53['holdout']:.2f}({res_v53['diff_A']:>+5.2f}) | OOF={res_v53['oof']:.2f}({res_v53['diff_B']:>+5.2f}) | LGB={res_v53['w_lgb']:.2f}, CB={res_v53['w_cb']:.2f} | {res_v53['guardrail_status']}")

    # =========================================================================
    # [Exp 2] v54: LightGBM ExtraTrees Mode + CatBoost 10-Fold Stacking
    # =========================================================================
    print("\n" + "=" * 70)
    print("▶ [Exp 2/2] v54: LightGBM ExtraTrees Mode (extra_trees=True) + CatBoost 10-Fold Stacking")
    print("=" * 70)
    res_v54 = run_pipeline(fe_v14, val_fe_v14, ALL_FEATURES_V14, n_splits=10, extra_trees=True)
    res_v54["experiment"] = "Exp 2 (v54-extratrees-10fold)"
    batch_results.append(res_v54)
    print(f"  Holdout={res_v54['holdout']:.2f}({res_v54['diff_A']:>+5.2f}) | OOF={res_v54['oof']:.2f}({res_v54['diff_B']:>+5.2f}) | LGB={res_v54['w_lgb']:.2f}, CB={res_v54['w_cb']:.2f} | {res_v54['guardrail_status']}")

    # =========================================================================
    # 종합 요약
    # =========================================================================
    print("\n" + "=" * 90)
    print("🏁 Wave 5 Autoresearch 종합 결과 및 5대 가드레일 판정")
    print("=" * 90)
    ...
    out = "docs/v53_to_v56_batch_results.csv"
