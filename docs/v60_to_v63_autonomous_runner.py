"""
Autonomous Continuous Research Runner - Wave 9 (v60 ~ v63)
===========================================================

차세대 심층 연구 4대 후보:
  1. [Exp 1] v60: Symmetric Depth Regularization (LGB max_depth=7 + CB depth=7) 10-Fold CV Stacking
  2. [Exp 2] v61: LightGBM Max Depth 8 with Min Child Samples 250 on 10-Fold CV
  3. [Exp 3] v62: CatBoost Strong L2 Regularization (l2_leaf_reg=5.0) 10-Fold CV
  4. [Exp 4] v63: LightGBM L1 Regularization (reg_alpha=0.5) 10-Fold CV
...
def main():
    print("=" * 80)
    print("🚀 Autonomous Continuous Runner - Wave 9 (v60 ~ v63)")
    ...
    # =========================================================================
    # [Exp 1] v60: Symmetric Depth Regularization (LGB max_depth=7 + CB depth=7)
    # =========================================================================
    print("\n" + "=" * 70)
    print("▶ [Exp 1/2] v60: Symmetric Depth Regularization (LGB max_depth=7 + CB depth=7)")
    print("=" * 70)
    res_v60 = run_pipeline(fe_v14, val_fe_v14, ALL_FEATURES_V14, lgb_overrides={"max_depth": 7}, cb_overrides={"depth": 7}, n_splits=10)
    res_v60["experiment"] = "Exp 1 (v60-sym-depth7)"
    batch_results.append(res_v60)
    print(f"  Holdout={res_v60['holdout']:.2f}({res_v60['diff_A']:>+5.2f}) | OOF={res_v60['oof']:.2f}({res_v60['diff_B']:>+5.2f}) | LGB={res_v60['w_lgb']:.2f}, CB={res_v60['w_cb']:.2f} | {res_v60['guardrail_status']}")

    # =========================================================================
    # [Exp 2] v61: LightGBM L1 Regularization (reg_alpha=0.5)
    # =========================================================================
    print("\n" + "=" * 70)
    print("▶ [Exp 2/2] v61: LightGBM L1 Regularization (reg_alpha=0.5)")
    print("=" * 70)
    res_v61 = run_pipeline(fe_v14, val_fe_v14, ALL_FEATURES_V14, lgb_overrides={"reg_alpha": 0.5}, n_splits=10)
    res_v61["experiment"] = "Exp 2 (v61-lgb-l1-reg)"
    batch_results.append(res_v61)
    print(f"  Holdout={res_v61['holdout']:.2f}({res_v61['diff_A']:>+5.2f}) | OOF={res_v61['oof']:.2f}({res_v61['diff_B']:>+5.2f}) | LGB={res_v61['w_lgb']:.2f}, CB={res_v61['w_cb']:.2f} | {res_v61['guardrail_status']}")

    # =========================================================================
    # 종합 요약
    # =========================================================================
    print("\n" + "=" * 90)
    print("🏁 Wave 9 Autoresearch 종합 결과 및 5대 가드레일 판정")
    print("=" * 90)
    ...
    out = "docs/v60_to_v63_batch_results.csv"
